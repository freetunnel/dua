...
curl https://raw.githubusercontent.com/freetunnel/dua/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/freetunnel/dua/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
