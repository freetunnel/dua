#!/bin/bash
repo="https://raw.githubusercontent.com/Freetunnel/bal/main/"
repo2="https://raw.githubusercontent.com/Freetunnel/dua/main/"
...
wget -q -O /usr/bin/menu "${repo2}menu/menu.sh" && chmod +x /usr/bin/menu
...
wget -q -O /usr/bin/running "${repo2}menu/running.sh" && chmod +x /usr/bin/running
