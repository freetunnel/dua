...
wget -q -O /usr/bin/update "https://raw.githubusercontent.com/freetunnel/dua/main/menu/update.sh" && chmod +x /usr/bin/update
...
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/freetunnel/dua/main/menu/running.sh" && chmod +x /usr/bin/running
